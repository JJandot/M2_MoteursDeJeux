...
#include "../hmin317-tp1/mainwidget.h"
...
QT_MOC_LITERAL(5, 41, 3) // "val"
    ...
    "MainWidget\0valueChanged\0\0newVal\0"
    "setValue\0val"
};
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWidget::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainWidget::valueChanged(int _t1)
{
